...
// checks if the StreamGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamGetResponse{}

// StreamGetResponse struct for StreamGetResponse
...
func (o StreamGetResponse) MarshalJSON() ([]byte, error) {
...
func (o StreamGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableStreamGetResponse struct {
	value *StreamGetResponse
	isSet bool
}

func (v NullableStreamGetResponse) Get() *StreamGetResponse {
	return v.value
}

func (v *NullableStreamGetResponse) Set(val *StreamGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGetResponse(val *StreamGetResponse) *NullableStreamGetResponse {
	return &NullableStreamGetResponse{value: val, isSet: true}
}

func (v NullableStreamGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
