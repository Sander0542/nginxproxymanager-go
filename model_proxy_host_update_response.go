...
// checks if the ProxyHostUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProxyHostUpdateResponse{}

// ProxyHostUpdateResponse struct for ProxyHostUpdateResponse
type ProxyHostUpdateResponse struct {
	// Unique identifier
...
func (o ProxyHostUpdateResponse) MarshalJSON() ([]byte, error) {
...
func (o ProxyHostUpdateResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProxyHostUpdateResponse struct {
	value *ProxyHostUpdateResponse
	isSet bool
}

func (v NullableProxyHostUpdateResponse) Get() *ProxyHostUpdateResponse {
	return v.value
}

func (v *NullableProxyHostUpdateResponse) Set(val *ProxyHostUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProxyHostUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProxyHostUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProxyHostUpdateResponse(val *ProxyHostUpdateResponse) *NullableProxyHostUpdateResponse {
	return &NullableProxyHostUpdateResponse{value: val, isSet: true}
}

func (v NullableProxyHostUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProxyHostUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
