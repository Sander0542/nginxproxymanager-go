...
// checks if the DeadHostCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeadHostCreateResponse{}

// DeadHostCreateResponse struct for DeadHostCreateResponse
type DeadHostCreateResponse struct {
	// Unique identifier
...
func (o DeadHostCreateResponse) MarshalJSON() ([]byte, error) {
...
func (o DeadHostCreateResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDeadHostCreateResponse struct {
	value *DeadHostCreateResponse
	isSet bool
}

func (v NullableDeadHostCreateResponse) Get() *DeadHostCreateResponse {
	return v.value
}

func (v *NullableDeadHostCreateResponse) Set(val *DeadHostCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeadHostCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeadHostCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeadHostCreateResponse(val *DeadHostCreateResponse) *NullableDeadHostCreateResponse {
	return &NullableDeadHostCreateResponse{value: val, isSet: true}
}

func (v NullableDeadHostCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeadHostCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
