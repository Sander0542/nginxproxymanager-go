...
// checks if the DeadHostUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeadHostUpdateResponse{}

// DeadHostUpdateResponse struct for DeadHostUpdateResponse
type DeadHostUpdateResponse struct {
	// Unique identifier
...
func (o DeadHostUpdateResponse) MarshalJSON() ([]byte, error) {
...
func (o DeadHostUpdateResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDeadHostUpdateResponse struct {
	value *DeadHostUpdateResponse
	isSet bool
}

func (v NullableDeadHostUpdateResponse) Get() *DeadHostUpdateResponse {
	return v.value
}

func (v *NullableDeadHostUpdateResponse) Set(val *DeadHostUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeadHostUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeadHostUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeadHostUpdateResponse(val *DeadHostUpdateResponse) *NullableDeadHostUpdateResponse {
	return &NullableDeadHostUpdateResponse{value: val, isSet: true}
}

func (v NullableDeadHostUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeadHostUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
