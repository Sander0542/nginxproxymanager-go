...
// checks if the StreamCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamCreateResponse{}

// StreamCreateResponse struct for StreamCreateResponse
...
func (o StreamCreateResponse) MarshalJSON() ([]byte, error) {
...
func (o StreamCreateResponse) ToMap() (map[string]interface{}, error) {
...
type NullableStreamCreateResponse struct {
	value *StreamCreateResponse
	isSet bool
}

func (v NullableStreamCreateResponse) Get() *StreamCreateResponse {
	return v.value
}

func (v *NullableStreamCreateResponse) Set(val *StreamCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamCreateResponse(val *StreamCreateResponse) *NullableStreamCreateResponse {
	return &NullableStreamCreateResponse{value: val, isSet: true}
}

func (v NullableStreamCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
