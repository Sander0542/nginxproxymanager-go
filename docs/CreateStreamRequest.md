...
`func (o *CreateStreamRequest) GetForwardingHost() CreateStreamRequestForwardingHost`

GetForwardingHost returns the ForwardingHost field if non-nil, zero value otherwise.

### GetForwardingHostOk

`func (o *CreateStreamRequest) GetForwardingHostOk() (*CreateStreamRequestForwardingHost, bool)`
...
`func (o *CreateStreamRequest) SetForwardingHost(v CreateStreamRequestForwardingHost)`
