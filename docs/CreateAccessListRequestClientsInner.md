# CreateAccessListRequestClientsInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Address** | Pointer to [**GetAccessLists200ResponseAddress**](GetAccessLists200ResponseAddress.md) |  | [optional] 
...
`func (o *CreateAccessListRequestClientsInner) GetAddress() GetAccessLists200ResponseAddress`

GetAddress returns the Address field if non-nil, zero value otherwise.

### GetAddressOk

`func (o *CreateAccessListRequestClientsInner) GetAddressOk() (*GetAccessLists200ResponseAddress, bool)`
...
`func (o *CreateAccessListRequestClientsInner) SetAddress(v GetAccessLists200ResponseAddress)`
