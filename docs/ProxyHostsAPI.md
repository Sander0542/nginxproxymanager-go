...
func main() {
	createProxyHostRequest := *openapiclient.NewCreateProxyHostRequest([]string{"DomainNames_example"}, "ForwardScheme_example", "ForwardHost_example", int32(123)) // CreateProxyHostRequest | Proxy Host Payload
