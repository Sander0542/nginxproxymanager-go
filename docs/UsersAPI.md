...
> GetCertificates200ResponseInnerOwner CreateUser(ctx).CreateUserRequest(createUserRequest).Execute()
...
func main() {
	...
	// response from `CreateUser`: GetCertificates200ResponseInnerOwner
...
[**GetCertificates200ResponseInnerOwner**](GetCertificates200ResponseInnerOwner.md)
...
> GetCertificates200ResponseInnerOwner GetUser(ctx, userID).Execute()
...
func main() {
	...
	// response from `GetUser`: GetCertificates200ResponseInnerOwner
...
> []GetCertificates200ResponseInnerOwner GetUsers(ctx).Expand(expand).Execute()
...
func main() {
	...
	// response from `GetUsers`: []GetCertificates200ResponseInnerOwner
...
> GetCertificates200ResponseInnerOwner UpdateUser(ctx, userID).UpdateUserRequest(updateUserRequest).Execute()
...
func main() {
	...
	// response from `UpdateUser`: GetCertificates200ResponseInnerOwner
